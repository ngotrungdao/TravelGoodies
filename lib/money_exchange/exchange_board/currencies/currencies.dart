...
import 'package:money_exchange/money_exchange/exchange_board/currencies/currency.dart';
...
class Currencies {
  ...
  void loadFromJson(Map<String, dynamic> json) {
    ...
    conversionRates = ratesJson.map<String, double>((
      String code,
      dynamic rate,
    ) {
  ...
  String _symbolOf(String currencyCode) {
    ...
    for (final country in Countries().countries) {
      if (country.currencyCode.toUpperCase() == normalizedCode) {
